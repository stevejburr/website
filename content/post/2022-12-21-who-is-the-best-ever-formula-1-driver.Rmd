...
We'll look at this in two ways, firstly based on peak performance. In the model Driver's ability can change over time comparing the highest values each driver has taken -
...
To try and control for that, let's look at the ranking based on the average performance across the best five years of a drivers career (but we could have picked another number and gotten different results!)


Even with one model, three (at least) answers to a question, and a huge range of other options!!


 
#### Additional analysis

- Red Bull overlap crew
- Replay recent seasons with % chances
- Lucky / unlucky drivers and % wins of championship
- Career car contribution

#### Conclusion

No objective analysis, the garden of forking paths
